...
public class ListaEnlazada<E> {
    ...
    public E getDato(int indice) throws VacioException, PosicionException {
        // Implementación para obtener el dato en el índice dado
        // Asegúrate de validar el índice y manejar las excepciones correctamente
        return null;
        // Implementación para obtener el dato en el índice dado
        // Asegúrate de validar el índice y manejar las excepciones correctamente
    }

    public void setDato(int indice, E dato) throws VacioException, PosicionException {
        // Implementación para establecer el dato en el índice dado
        // Asegúrate de validar el índice y manejar las excepciones correctamente
    }
...
//    public NodoLista<Integer> getUltimoNodo() {
//        if (isEmpty()) {
//            return null;
//        }
//
//        NodoLista<Integer> nodoActual = (NodoLista<Integer>) cabecera;
...
//    }
//
//    public void setUltimoNodo(NodoLista<Integer> ultimoNodo) {
//        if (isEmpty()) {
//            cabecera = (NodoLista<E>) ultimoNodo;
//        } else {
//            NodoLista<Integer> nodoActual = (NodoLista<Integer>) cabecera;
//            while (nodoActual.getSig() != null) {
//                nodoActual = nodoActual.getSig();
//            }
//            nodoActual.setSig(ultimoNodo);
//        }
//    }
